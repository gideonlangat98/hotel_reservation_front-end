...
function Home() {
    ...
    return (
      <div className='bg-page'>
        ...
        <div>
          <h2 style={{color: "green", marginTop: "3rem"}}>Our Services</h2>
        </div>
        <div>
          <div>
          ...
          <div>
            <h4>Massage</h4>
            <p>We offer two massage rooms located on <br></br>the 4th floor of the hotel. The expert <br></br>hands of our masseuses will invite you <br></br>to total relaxation.</p>
          </div>
          <div>
            <h4>Guarded parking Lot</h4>
            <p></p>
          </div>
        </div>
